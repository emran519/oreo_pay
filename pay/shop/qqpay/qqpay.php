...
if(isset($_GET['type']))$DB->query("update `oreo_order` set `type` ='qqpay',`addtime` ='$date' where `trade_no`='$trade_no'");

$name = $conf['oreo_ordername'];

require_once (SYSTEM_ROOT.'oreo_static/pay/qqpay/qpayMchAPI.class.php');
...
$params["body"] = $name;
$params["fee_type"] = "CNY";
$params["notify_url"] = $oreoport.'/pay/shop/qqpay/qqpay_notify.php';
