...
require_once SYSTEM_ROOT."oreo_function/pay/wxpay/WxPay.NativePay.php";
...
$input->SetNotify_url($protocol.'/pay/weixin/wxpay_notify.php');
$input->SetTrade_type("MWEB");
$result = $notify->GetPayUrl($input);
if($result["result_code"]=='SUCCESS'){
	$redirect_url='http://'.$_SERVER['HTTP_HOST'].'/pay/weixin/wxwap_return.php?trade_no='.$trade_no;
