...
$target_url = $protocol . '/pay/zmpay/wxjspay.php?trade_no=' . $trade_no;
?>
<html lang="zh-cn">
<head>
    <meta charset="utf-8"/>
...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 center-block" style="float: none;">
    <div class="panel panel-primary">
        ...
        <img src="../../assets/pay/image/wechat.ico">微信支付手机版
        </div>
        <div class="list-group" style="text-align: center;">
            ...
            <div class="list-group-item">
                <a href="<?php echo $target_url ?>"><?php echo $target_url ?></a><br/>
                <button id="copy-btn" data-clipboard-text="<?php echo $target_url ?>" class="btn btn-info btn-sm">一键复制
                </button>
            </div>
