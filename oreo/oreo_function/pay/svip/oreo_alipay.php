...
$alilxddcx=$DB->query("select * from oreo_order WHERE status='1' AND type='alipay' AND svip='1' AND DATE_FORMAT(endtime,'%y-%m-%d')=DATE_FORMAT(now(),'%y-%m-%d') order by endtime desc limit 1")->fetch();
