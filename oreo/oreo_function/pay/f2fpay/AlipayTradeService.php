 ...
 * Time: 下午2:09
 */
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/lib/AopClient.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/request/AlipayTradeCancelRequest.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/request/AlipayTradePayRequest.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/request/AlipayTradePrecreateRequest.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/request/AlipayTradeQueryRequest.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/request/AlipayTradeRefundRequest.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/result/AlipayF2FPayResult.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/result/AlipayF2FQueryResult.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/result/AlipayF2FRefundResult.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/result/AlipayF2FPrecreateResult.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/builder/AlipayTradeQueryContentBuilder.php';
require_once SYSTEM_ROOT.'oreo_function/pay/f2fpay/model/builder/AlipayTradeCancelContentBuilder.php';
require SYSTEM_ROOT.'oreo_function/pay/f2fpay/config.php';
...
class AlipayTradeService {
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		file_put_contents ( SYSTEM_ROOT."oreo_function/pay/f2fpay/log/log.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
